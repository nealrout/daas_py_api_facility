"""
Django settings for facility_api project.
...
SECRET_KEY = 'django-insecure-1*43!5$s&^h16gs^wjk#ke4)gxpb$7dy=ou*h$jlz7tn(#8e(z'
...
ROOT_URLCONF = 'facility_api.urls'
...
WSGI_APPLICATION = 'facility_api.wsgi.application'
